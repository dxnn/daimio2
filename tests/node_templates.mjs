...
var make_dialect = function(dialect) {
  // NOTE: D.dialect_add no longer exists — current API is new D.Dialect(commands, aliases).
  // This test predates the current API and needs updating.
  return D.dialect_add(dialect)
}

// TESTS GO HERE!!!!

var dialect = make_dialect({commands: {math: {add: true}}, aliases: {add: "math add value"}})
